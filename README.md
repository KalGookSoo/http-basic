...
#### [01-2 IP(인터넷 프로토콜)](chapters/01-2-IP-인터넷-프로토콜.md)
- IP 주소의 구조(IPv4/IPv6)
- 라우팅과 서브네팅의 기초 개념
- IP 패킷의 구성 요소(헤더, 페이로드)

#### [01-3 TCP, UDP](chapters/01-3-TCP-UDP.md)
...
#### [02-1 URI](chapters/02-1-URI.md)
- URI/URL/URN의 차이
- 스키마, 호스트, 포트, 경로, 쿼리, 프래그먼트 구성
- 인코딩 규칙과 예약 문자

#### [02-2 웹 브라우저 요청 흐름](chapters/02-2-웹-브라우저-요청-흐름.md)
...
#### [03-2 클라이언트 서버 구조](chapters/03-2-클라이언트-서버-구조.md)
...
#### [04-1 HTTP API를 만들어보자](chapters/04-1-HTTP-API를-만들어보자.md)
...
#### [04-4 HTTP 메서드의 속성](chapters/04-4-HTTP-메서드의-속성.md)
